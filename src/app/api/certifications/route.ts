  ...
  try {
    ...
    const certifications = result.rows.map((cert) => {
        ...
        return {
          ...
          inspectionConfirmed: cert.inspection_confirmed ?? false,
          inspectionProposedDate: cert.inspection_proposed_date,
          inspectionProposedBy: cert.inspection_proposed_by,
